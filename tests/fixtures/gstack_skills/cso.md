<!--
CONTENT-DRIFT-NOTE (phase 03, plan 03-01 Task 1): Upstream gstack /cso v2.0.0 ships
TWENTY-TWO hard false-positive exclusions, NOT 17 as D-13 expected. They live in
"Phase 12: False Positive Filtering + Active Verification" section.
Actual 22 exclusions (enumerated verbatim below):
...
Plus 12 numbered precedents and 8/10 confidence gate. Wave 2 (03-04-PLAN) must
port these 22 exclusions verbatim into security.md; D-14 budget gate must
accommodate the enlarged list (4 KB hard cap may need soft-cap uplift for this
one file — planner of 03-04 to decide per D-14 rules).
-->
---
name: cso
preamble-tier: 2

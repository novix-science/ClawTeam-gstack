<!--
CONTENT-DRIFT-NOTE (phase 03, plan 03-01 Task 1): Upstream gstack /office-hours v2.0.0
still has SIX forcing questions (matches D-13 count of 6), but the section header is
"The Six Forcing Questions" with Q1-Q6 named: Demand Reality, Status Quo,
Desperate Specificity, Narrowest Wedge, Observation & Surprise, Future-Fit.
The literal phrase "Why now?" is NOT present in upstream; the "why now" concept
is embedded in Q6 (Future-Fit, "If the world looks meaningfully different in 3
years...") and partly in Q2 (Status Quo). Wave 2 (03-04-PLAN) must use the
verbatim Q1-Q6 names above when porting pm.md, NOT the legacy "Why now?" phrasing.
-->
---
name: office-hours
preamble-tier: 3
